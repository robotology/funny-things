...
go_home_helperL() {
    # This is with the arms close to the legs
     echo "ctpq time $1 off 0 pos (-21.7695	17.9352	0.203248	28.0262	0	0	-0.0439454	15.3864	29.8334	1.95557	11.7389	0.351563	7.43227	2.46644	1.06018	2.38404	)" | yarp rpc /ctpservice/left_arm/rpc
}

go_home_helperR() {
    # This is with the arms close to the legs
     echo "ctpq time $1 off 0 pos (-21.7 24.1535 23.5987	28.1361	-22.7912	0	-4.42201	18.1385	28.9106	0	5.46571	0.373536	1.66993	0.379029	0	-0.422975	)" | yarp rpc /ctpservice/right_arm/rpc
}
...
look_schermo(){
gaze "look-around 30.0 10.0 3.0"
}
...
speak "che anche da molto lontano qualcuno potrebbe vedere cosa ri levano i miei sensori."
sleep 6.0
gaze "look-around 15.0 0.0 3.0"
wait_till_quiet
smile
