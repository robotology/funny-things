...
you(){
    %echo "ctpq time 0.2 off 7 pos (38.0 61.0 44.0 138.0 43.0 2.0 75.0 160.0 240.0)" | yarp rpc /ctpservice/left_arm/rpc
    sleep 1.5
    echo "ctpq time 1.5 off 0 pos (-77.0 16.0 10.0 47.0 82.0 -23.0 7.0 38.0 61.0 44.0 138.0 43.0 2.0 75.0 160.0 240.0)" | yarp rpc /ctpservice/left_arm/rpc
}
...
buongiorno(){
  greet_like_god
  speak "Buongiorno a tutti, e benvenuti alla conferenza A D P 5.0: Verso un nuovo equilibrio tra lavoro, tecnologia e persone!"
  go_home
}
...
noi_robot(){
  speak "Oggi mi piacerebbe mostrarvi come noi robot stiamo imparando a collaborare e cooperare con voi umani per potervi assistere in futuro."
  sleep 1.0
  me_and_you
  sleep 3.0
  go_home  
