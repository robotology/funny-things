...
push_liquid() {
    ...
    sleep 2.5
    echo "-0.135 -0.360 -0.015 -0.155917 0.702537 -0.694357 2.598576" | yarp write ... /armCtrl/left_arm/xd:i
    sleep 4.0
    echo "-0.120 -0.300 -0.025 -0.155917 0.702537 -0.694357 2.598576" | yarp write ... /armCtrl/left_arm/xd:i
    sleep 1.0
    echo "-0.090 -0.300 -0.020 -0.155917 0.702537 -0.694357 2.598576" | yarp write ... /armCtrl/left_arm/xd:i
    sleep 1.5
}
...
pour_syrup() {
    ...
    echo "-0.220 -0.250 0.030 -0.155917 0.702537 -0.694357 2.598576" | yarp write ... /armCtrl/left_arm/xd:i
    sleep 2.0
    echo "-0.310 -0.250 0.030 -0.155917 0.702537 -0.694357 2.598576" | yarp write ... /armCtrl/left_arm/xd:i
    sleep 3.0
    echo "-0.220 -0.250 0.030 -0.155917 0.702537 -0.694357 2.598576" | yarp write ... /armCtrl/left_arm/xd:i
    sleep 3.0
