...
modified: 2013-08-20
tags: [sample post, documentation, highlighting]
image:
...
To modify styling and highlight colors edit `agency.css` if that's your thing, the classes you want to modify all begin with `.highlight`.
